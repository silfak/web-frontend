    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 w-[420px] shadow-xl">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full border border-gray-300 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
                  (type === "ob" || type === "admin") ? "pl-9 pr-3" : "px-3"
                }`}
                placeholder={
                  type === "gedung" ? "Contoh: Gedung Ki Hajar Dewantara" :
                  type === "ruangan" ? "Masukkan nama ruangan" :
                  type === "jenis" ? "Contoh: Kerusakan Listrik" :
                  type === "ob" ? "Masukkan nama OB" :
                  "Masukkan nama Admin"
                }
              />
            </div>
          ...
          {/* KONFIRMASI PASSWORD - hanya OB & Admin */}
          {(type === "ob" || type === "admin") && (
            <div>
              ...
              {type === "ob" && (
                <p className="text-xs text-gray-400 mt-1 flex items-center gap-1">
                  Password ini akan digunakan OB untuk login pertama kali
                </p>
              )}
            </div>
          )}
