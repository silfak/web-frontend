...
return (
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden animate-in fade-in duration-500">
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50">
        <div className="space-y-2">
          ...
          <select 
            ...
            className="w-full p-3 bg-white border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#107C41]/10 cursor-pointer"
          >
      ...
      {/* --- KONDISI: JIKA HASIL FILTER KOSONG (Desain Sama dengan Mahasiswa) --- */}
      {filteredReports.length === 0 ? (
        <div className="p-20 flex flex-col items-center justify-center text-center space-y-4">
          ...
          <button 
            ...
            className="text-sm font-bold text-[#107C41] hover:underline transition-all"
          >
            Reset Semua Filter
          </button>
        </div>
          ...
          <div className="p-6 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium">
            <p className="text-gray-500">
              Menampilkan <span className="text-[#107C41] font-bold">
                {indexOfFirstItem + 1} - {Math.min(indexOfLastItem, filteredReports.length)}
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="p-2 border rounded-lg hover:bg-gray-50 disabled:opacity-30 transition-all shadow-sm"
              >
                <ChevronLeft size={16}/>
              </button>
