...
export default function DeleteModal({
  ...
  const getDesc = () => {
    if (deleteType === "gedung") {
      return "Menghapus gedung akan menghapus semua ruangan di dalamnya. Data yang dihapus tidak dapat dipulihkan.";
    }
    if (deleteType === "ruangan") {
      return "Ruangan ini akan dihapus dari sistem. Data yang dihapus tidak dapat dipulihkan.";
    }
    if (deleteType === "jenis") {
      return "Jenis masalah ini akan dihapus dari sistem. Data yang dihapus tidak dapat dipulihkan.";
    }
